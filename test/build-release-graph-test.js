...
describe(buildReleaseGraph, function() {
  ...
  it('bumps a package with a chain of dependent changes', async function() {
    fixturify.writeSync(tmpPath, {
      'packages': {
        'package-c': {
          'package.json': stringifyJson({
  ...
  it('takes the greater release type of different dependent packages', async function() {
    fixturify.writeSync(tmpPath, {
      'packages': {
        'package-c': {
          'package.json': stringifyJson({
  ...
  it('takes the greater dependency type when deciding if it should bump in range version', async function() {
    fixturify.writeSync(tmpPath, {
      'packages': {
        'package-c': {
          'package.json': stringifyJson({
  ...
  it('takes the greater dependency type when deciding if it should bump out of range version', async function() {
    fixturify.writeSync(tmpPath, {
      'packages': {
        'package-c': {
          'package.json': stringifyJson({
